    ...
    <div className="space-y-4">
      {error && (
        <div className="p-3 text-sm text-red-600 bg-red-50 border border-red-200 rounded">
          ...
          {error === 'EmailSignin' && 'Unable to send email. Please try again.'}
          ...
          {!['CredentialsSignin', 'EmailSignin', 'OAuthSignin', 'OAuthCallback', 'OAuthCreateAccount', 'EmailCreateAccount', 'Callback', 'OAuthAccountNotLinked', 'SessionRequired'].includes(error) && 'An error occurred during sign in.'}
        </div>
      )}
